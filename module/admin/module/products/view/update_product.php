<?php 
    ...
    <a href='index.php?page=products&op=update_product&id=".$_GET['id']."' data-tr='Update Product'></a>"; 
?>
...
<form method="post" name="form_create_product" id="form_create_product">
    ...
    <input class="add_button" name="add" type="button" value="Add product" onclick="product_validator_js()"/>
    <input class="reset_button" name="reset" type="reset" value="Restore"/>
</form>