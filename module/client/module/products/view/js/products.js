            ...
            success: function(result){
                ...
                if (result == 'error') {
                    ...
                    for (let index = 0; index < result.length; index++) {
                        element = element + '<div id_button="'+result[index][0]+'" class="product"><div class="img"></div><div class="data"><p class="title_product">'+result[index][1]+'</p><div class="star"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i>(23)</div></div></div>';
                    }
...
var pintadas = 0;
function count_productos(por_pintar){
    pintadas = pintadas + por_pintar;
    $.ajax({
        url: "module/client/module/products/controller/products.php",
        dataType: 'json',
        ...
        subcategory: localStorage.getItem('subcategory')},
        success: function(result){
            $('.text').html(pintadas + ' - ' + result.length + ' resultados para');
      }});
}
